...
--SORU3: isim'i buyuk harf kucuk harf gözetmeksizin 'A' ile baslayan tum bilgileri listeleyinizs payyişdayn

select * from musteriler where isim ilike 'A%'

--not :  buyuk harf kucuk harf gozetmeksızın listelemek ıstersek ilike kullanırız.
...
--not : butuk harf kucuk harf gözetmeksızın listelemek istersek ~* kullanırız

-- SORU3 : ilk harfi 'h', son harfi 't' olup, 2.harfi 'a' ile 'k' arasinda 
--olan 3 harfli kelimelerin  tum bilgilerini listeleyiniz
