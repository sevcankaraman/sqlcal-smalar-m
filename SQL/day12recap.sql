...
-- burdakı ın komutu ıle ısyerlerını parantez ıcınde belırtebılırz
...
right join yazarlar A 
on A.kitap_id=B.kitap_id

--SORU3: Her iki tabloda kitap_id'si ortak olan verilerin 
--kitap_isim ve yazar_isim'lerini listeleyiniz
