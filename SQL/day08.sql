...
round(avg(yas))as yas_ort from insan
...
select ulke,round(avg(yas))as yas_ort from insan  group by ulke having avg(yas)>30;
...
------------------------------------------------------------------------------*/
select maas , isim  as isim_şehir from personel  where maas >4000
UNION
select maas , sehir as  from personel where maas>5000;
